...
public class ProbabilityState {
	 ...
	 *
	 * @param dataVector
	 *            Input vector. It is discretised to the floor of each value.
	 */
	 ...
	 * @param outputVector
	 *            The normalised vector. Must be instantiated to length
	 *            inputVector.length.
	 ...
	 *            The second vector.
	 * @param outputVector
	 *            The merged vector. Must be instantiated to length
	 *            inputVector.length.
